...
max_plot_iteration = 2000 # Maximum number of training steps to report performance
...
#    plt.fill_between(range(0, max_iteration), grasp_success, 0, color=color, alpha=0.5)
